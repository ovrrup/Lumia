...
# We need to add eraseMyDataAndAccount and deleteProfileWithSuccessor
new_methods = """
    fun deleteProfileWithSuccessor(successorId: String, createNew: Boolean = false, newName: String = "", newAvatar: String = "") {
...
# Let's insert this near eraseAllDataAndSettings
idx = content.find("fun eraseAllDataAndSettings()")
if idx != -1:
