...
object AchievementSystem {
    val ACHIEVEMENTS = listOf(
        // Points based
        AchievementDef("P_100", "Beginner I", "Reach 100 points.", "POINTS", 100, "Novice", "feat_theme_overlay"),
        AchievementDef("P_500", "Intermediate I", "Reach 500 points.", "POINTS", 500, "Scroll"),
        AchievementDef("P_1000", "Advanced I", "Reach 1,000 points.", "POINTS", 1000, "Cap"),
        AchievementDef("P_5000", "Elite", "Reach 5,000 points.", "POINTS", 5000, "Crown"),
        AchievementDef("P_10000", "Expert", "Reach 10,000 points.", "POINTS", 10000, "Star"),
        // Tasks based
        ...
        AchievementDef("P_200", "Beginner II", "Reach 200 points.", "POINTS", 200, "Book"),
        AchievementDef("P_300", "Beginner III", "Reach 300 points.", "POINTS", 300, "Book"),
        AchievementDef("P_400", "Beginner IV", "Reach 400 points.", "POINTS", 400, "Book"),
        AchievementDef("P_600", "Intermediate II", "Reach 600 points.", "POINTS", 600, "Scroll"),
        AchievementDef("P_700", "Intermediate III", "Reach 700 points.", "POINTS", 700, "Scroll"),
        AchievementDef("P_800", "Intermediate IV", "Reach 800 points.", "POINTS", 800, "Scroll"),
        AchievementDef("P_900", "Intermediate V", "Reach 900 points.", "POINTS", 900, "Scroll"),
        AchievementDef("P_1500", "Advanced II", "Reach 1,500 points.", "POINTS", 1500, "Cap"),
        AchievementDef("P_2000", "Advanced III", "Reach 2,000 points.", "POINTS", 2000, "Cap"),
        AchievementDef("P_2500", "Advanced IV", "Reach 2,500 points.", "POINTS", 2500, "Cap"),
        AchievementDef("P_3000", "Advanced V", "Reach 3,000 points.", "POINTS", 3000, "Cap"),
        AchievementDef("P_4000", "Advanced VI", "Reach 4,000 points.", "POINTS", 4000, "Cap"),
        ...
        AchievementDef("P_15000", "Master", "Reach 15,000 points.", "POINTS", 15000, "Star"),
        AchievementDef("P_20000", "Legend", "Reach 20,000 points.", "POINTS", 20000, "Star")
    )
