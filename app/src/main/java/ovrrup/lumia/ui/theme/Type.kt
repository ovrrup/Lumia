...
fun getTypography(fontNameStr: String, headingFontNameStr: String? = null): Typography {
    val heading = headingFontNameStr ?: fontNameStr

    val bodyFamily = if (fontNameStr == "System Default") FontFamily.Default else {
    ...
    val headingFamily = if (heading == "System Default") FontFamily.Default else {
