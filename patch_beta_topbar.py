...
with open("app/src/main/java/lumia/tracker/ui/screens/settings/BetaFeaturesScreen.kt", "r") as f:
    content = f.read()

old_beta_topbar = """    val isGlass = lumia.tracker.ui.theme.LocalGlassMode.current
    Scaffold(
...
new_beta_topbar = """    val betaEnhancedHeader by viewModel.betaEnhancedHeader.collectAsStateWithLifecycle()
...
content = content.replace(old_beta_topbar, new_beta_topbar)

with open("app/src/main/java/lumia/tracker/ui/screens/settings/BetaFeaturesScreen.kt", "w") as f:
    f.write(content)
print("Replaced topbar in BetaFeaturesScreen!")
